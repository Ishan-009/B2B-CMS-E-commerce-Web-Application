        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 style="padding-top: 10px;">Welcome To Edit Main-Category Section 	</h5>
				   <!-- Main content -->
...
<br>
  <div class="card-header">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url();?>admin/category/UpdateCat" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
					  <input type="hidden" name="id"value="<?php echo $cat['id']?>">
                    <label for="ProductName">category Name</label>
                    <input type="text" name="name" class="form-control" id="ProdName01" placeholder="Enter Product Name" value="<?php echo set_value('name',$cat['name']);?>">
				  </div>
				  <?php echo form_error('name');?>
                   ...
                   <label for="customFile">Upload Image File</label> 
                	...
                	<input type="file" class="custom-file-input"  name="profile_img" value="<?php echo set_value('profile_img',$cat['image']);?>">			
...
<?php if($this->session->flashdata('categoryU')):?>
	<div align ="center" style="color: red" class="bg-success" style="width: 100%;">
	<?php echo $this->session->flashdata('categoryU');?>
</div>
<?php endif;?>
<?php if($this->session->flashdata('Image01')):?>
	<div align ="center" style="color: red" class="bg-danger" style="width: 100%;">
