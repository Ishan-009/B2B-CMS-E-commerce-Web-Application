        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 style="padding-top: 10px;">Welcome To The  Edit Logo  Section 	</h5>
				   <!-- Main content -->
...
<br>
            <div class="card card-primary" >
              <div class="card-header">
               <h3 class="card-title"> Edit Logo Image </h3>
              </div>
             
              <form  action="<?php echo base_url().'admin/UserL/updatelogo'?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
								<div class="form-group">
                    <label for="BImage Name"> Logo Image  Name</label>
                    <input type="text" name="name" class="form-control" id="Image01" placeholder="Enter Banner  Name" value="<?php echo set_value('name',$logo['name']);?>">
				  </div>

					<div class="form-group">
                    
                    <input type="hidden" name="id" class="form-control" id="Imageid" value="<?php echo set_value('id',$logo['id']);?>">
				  </div>
				  </div>

                <!-- /.card-body -->
								<label>Upload Logo Images </label>
