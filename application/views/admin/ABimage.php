        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 style="padding-top: 10px;">Welcome To The Banner Image Section 	</h5>
				   <!-- Main content -->
...
<br>
            <div class="card card-primary" >
              ...
              <form  action="<?php echo base_url().'admin/UserL/AddBImage'?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
								<div class="form-group">
                    <label for="BImage Name"> Banner Image  Name</label>
                    <input type="text" name="name" class="form-control" id="Image01" placeholder="Enter Banner  Name">
				  </div>
