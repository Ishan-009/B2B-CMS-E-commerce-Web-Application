        ...
        <div class="row">
          ...
          <div class="col-md-10" style="padding: 30px 0 0 250px">
            ...
            <div class="card card-primary" >
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url();?>admin/product/addProduct" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="ProductName">Product Name</label>
                    <input type="text" name="name" class="form-control" id="ProdName01" placeholder="Enter Product Name">
				  </div>
                    ...
                    <div class="col-sm-12" style="padding-left: 20px;">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="text-area form-control" rows="3" id="desc" name="desc" > <?php echo set_value('desc');?>	</textarea>
										...
										<br>
										<div class="row">
                    <div class="col-lg-12" class="form-control" style="padding-left:180px">
                      <!-- select -->
                      <div class="form-group">
