...
<div class="content">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 style="padding-top: 10px;">Welcome To The Sub-Category Section 	</h5>
				   <!-- Main content -->
      ...
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
          <div class="col-md-10" style="padding: 50px 0 0 150px;" >
...
<br>
            <div class="card card-primary" >
              <div class="card-header">
               <h3 class="card-title"> Sub-category Section</h3>
              </div>
             
              <form  action="<?php echo base_url().'admin/category/addsubcategory'?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
